...
# Defaut role to assign to new users, defaults to 'user'
DEFAULT_ROLE = "user"
...
# removes uploaded tar.gz containing scim files
CLEANUP = False

# OpenStack settings and credentials
...
#  e.g.:
#  SSH_KEY_BLOCKLIST = [
#  "AAAAMjViNzU0ZjQ2ZDAyZjIzZTY1NDMxYjFiZGY5YTliYzQzOTRkCg==",
#  "AAAANDM5ZTE5ZDAzMmZkYmJmYTYxZmRlMWMxMjIzZDdlM2JjNDIxCg=="
#  ]
